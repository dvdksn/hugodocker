...
volume drivers are available to support other use cases ([SFTP](https://github.com/vieux/docker-volume-sshfs), and more).
...
[Multi container apps](07_multi_container.md)
