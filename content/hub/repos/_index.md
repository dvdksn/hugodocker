...
![Create Private Repo](/docker-hub/images/repo-create-private.png)

## Deleting a repository

1. Navigate to [Docker Hub](https://hub.docker.com) and select **Repositories**.
...
1. Navigate to [Docker Hub](https://hub.docker.com) create a Docker ID and select the personal subscription.
...
3. Sign in to [Docker Hub](https://hub.docker.com) using your original Docker ID, and pull your images from the initial namespace.
