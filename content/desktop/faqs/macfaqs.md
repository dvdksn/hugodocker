...
} To activate completion for Docker commands, these files need to be
...
system](https://fishshell.com/docs/current/#tab-completion){:
}. To activate completion for Docker commands,
