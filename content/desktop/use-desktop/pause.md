...
From the Docker menu, select![whale menu](../images/whale-x.svg) and then **Pause** to pause Docker Desktop.
...
Select ![whale menu](../images/whale-x.svg) then **Resume** to resume Docker Desktop.
